    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
      ...
      >
        ...
        <h1 className="text-4xl font-bold mb-4">
          Disease Information <span className="gradient-text">Library</span>
        </h1>
        <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
          Comprehensive knowledge about diseases detected by Jeevansh AI —
                ...
                <Card className="medical-card group cursor-pointer h-full overflow-hidden">
                  <div className="h-40 overflow-hidden relative">
                    ...
                    <div className="absolute top-3 right-3">
                      <Badge variant={severityColor[d.severity as keyof typeof severityColor]}>
                        {d.severity} risk
                      </Badge>
                    </div>
                  </div>
